...
extension UIFont {
    ...
    public static let bitterTitle2: UIFont = .bitterFont(.medium, ofSize: 24)
    public static let bitterTitle3: UIFont = .bitterFont(.medium, ofSize: 22)
    public static let bitterHeadline: UIFont = .bitterFont(.semiBold, ofSize: 20)
    public static let bitterSubheadline: UIFont = .bitterFont(.medium, ofSize: 18)
